  ...
  return (
    <div className={styles.navi}>
      <Link to={'/home'}>
        ...
        <Modal show={show} onHide={handleClose} className={styles['modal-wrap']}>
          <Modal.Body className={styles.modal}>
            ...
            <div className={styles['modal-ticket']}>
              ...
              <p>How many person?</p>
              <div>
                <select name="child" id="child" className={styles.ticket} onChange={(e)=>{setChild(e.target.value)}}>
                ...
                <select name="adult" id="adult" className={styles.ticket} onChange={(e)=>{setAdult(e.target.value)}}>
